/*INTUITION
There are 7 unique minimum substrings possible.
{"aa","aba","aca","abca","acba","abbacca","accabba"}
Every other substring will be formed by their combination so they will not be minimum so we have to check all substrings of length 2 to 7
We know that in the substring freq['a']>freq['b']  and freq['a']>freq['c'], 
So for every index i check substring starting from index i of length 2 to 7 if this condition is met and find the minimum of all those substrings.
*/
