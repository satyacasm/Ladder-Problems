/*Intuition => Observe that only 11 and 111 are enough as 1111,11111.. can be represented as sum of 11 and 111.
Now, X = A.11 + B.111,

B can be writted as B = 11.C + D  where 0<=D<11

Keeping this back in above equation,

X = (A+111.C)11 + 111.D

Bruteforce value of D from 0 to 10 and check if the resulting difference is divisible by 11. 
*/
